import { Card, Tag, Typography } from '@ecom/aurora'
...
const KIND = {
  cfg: {
    ...
    icon: '⚙️',
    head: '配置中心 · 规划中',
    desc: '分级审批路由、跨域升档规则、白名单范围等配置能力将在后续版本开放。',
  ...
  assetin: {
    ...
    icon: '📥',
    head: '资产接入 · 规划中',
    desc: '人消费标签接入（Hive 表 → Triton）、系统间调用接入（PSM → DMP / LDMP）、资产元数据登记与分级申报等能力将在后续版本开放。',
